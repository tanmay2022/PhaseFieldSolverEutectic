...
$$
\begin{aligned}
&{\tau}{\epsilon}{\frac {\partial \phi_i} {\partial t}} = -{\frac {2} {3}} \left[-{\epsilon}\left({\nabla}\cdot{\frac {\partial a({\nabla}\textbf{\phi})} {\partial {\nabla}\phi_i}}\right) + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_i}} + {\frac {\partial \Psi(T,\mu,\textbf{\phi})} {\partial \phi_i}} \right] \\
&+ {\frac {1} {3}} \left[-{\epsilon}\left({\nabla}\cdot{\frac {\partial a({\nabla}\textbf{\phi})} {\partial {\nabla}\phi_j}}\right) + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_j}} + {\frac {\partial \Psi(T,\mu,\textbf{\phi})} {\partial \phi_j}} \right] \\
&+ {\frac {1} {3}} \left[-{\epsilon}\left({\nabla}\cdot{\frac {\partial a({\nabla}\textbf{\phi})} {\partial {\nabla}\phi_k}}\right) + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_k}} + {\frac {\partial \Psi(T,\mu,\textbf{\phi})} {\partial \phi_k}} \right]
\end{aligned}
\tag{3}
\label{3}
$$
...
* The double well potential $w(\textbf{\phi})$ can be written as:

$$
w(\textbf{\phi}) = \sum_i 9{\gamma}{\phi_i}^2(1-{\phi_i})^2
\tag{4}
\label{4}
$$

* The gradient energy density, $a({\nabla}\textbf{\phi})$ has the form:

$$
a({\nabla}\textbf{\phi}) = \sum_i {\gamma} |{\nabla}{\phi_i}|^2
\tag{5}
\label{5}
$$
...
$$
\Psi (T,\mu,\textbf{\phi}) = \sum_i \Psi_i (T,\mu) h_i(\textbf{\phi})
\tag{6}
\label{6}
$$
...
* In equation (6), $h_i(\textbf{\phi})$ is an interpolation function given as:
...
$$
\begin{aligned}
&{\tau}{\epsilon}{\frac {\partial \phi_i} {\partial t}} = -{\frac {2} {3}} \left[-2{\gamma}{\epsilon}{\nabla}^2 {\phi_i} + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_i}} + \Psi_i (T,\mu) {\frac {\partial h_i(\textbf{\phi})} {\partial \phi_i}} \right] \\
&+ {\frac {1} {3}} \left[-2{\gamma}{\epsilon}{\nabla}^2 {\phi_j} + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_j}} + \Psi_j (T,\mu) {\frac {\partial h_j(\textbf{\phi})} {\partial \phi_j}} \right] \\
&+ {\frac {1} {3}} \left[-2{\gamma}{\epsilon}{\nabla}^2 {\phi_k} + {\frac {1} {\epsilon}}{\frac {\partial w(\textbf{\phi})} {\partial \phi_k}} + \Psi_k (T,\mu) {\frac {\partial h_k(\textbf{\phi})} {\partial \phi_k}} \right]
\end{aligned}                    
\tag{10}
\label{10}
$$
...
$$
\begin{aligned}
&\left[\sum_i {\frac {\partial c_i} {\partial \mu}} h_i(\textbf{\phi})\right]{\frac {\partial \mu} {\partial t}} + \sum_i c_i \left(\sum_n {\frac {\partial h_i} {\partial \phi_n}} {\frac {\partial \phi_n} {\partial t}} \right) \\
...
$$
\begin{aligned}
&\left[\sum_i {\frac {\partial c_i} {\partial \mu}} h_i(\textbf{\phi})\right]{\frac {\partial \mu} {\partial t}} - v{\frac {\partial c} {\partial x}} + \sum_i c_i \left(\sum_n {\frac {\partial h_i} {\partial \phi_n}} {\frac {\partial \phi_n} {\partial t}} \right) \\
&= \nabla \cdot \left(D \phi_{liq} {\frac {\partial c_{liq} (T,\mu)} {\partial \mu}} \nabla \mu \right) - \nabla \cdot j_{at}
\end{aligned}
\tag{16}
\label{16}
...
* Using the relation ${\frac {\partial \Psi (T,\mu,\textbf{\phi})} {\partial \mu}} = -c$ and equations (6--9), $\nabla c$ is evaluated.
...
```{r comment='', echo=FALSE}
cat(readLines('~/Documents/run/PhaseFieldSolverEutectic/eutecticGrowth2D/0/phi.orig'), sep = '\n')
```
