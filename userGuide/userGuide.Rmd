...
Similar to section 1.2.5, the startTime and deltaT are specified. The endTime keyword is set to 2000 to observe the growth of secondary dendrites from the primary dendrite, growing normal to the direction of imposed thermal gradient. The writeInterval can be set to 100. For this case, the entries in the *controlDict* are shown below:
...
Similar to section 1.2.5, the startTime and deltaT are specified. The endTime keyword is set to 3000 to observe the growth of secondary dendrites from the primary dendrite, growing normal to the direction of imposed thermal gradient. The writeInterval can be set to 100. For this case, the entries in the *controlDict* are shown below:
